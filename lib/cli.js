...
// fetch version info
pkginfo(require.main, 'version', 'name')
pkginfo(module, 'version')

let cliVersion = require.main.exports.version
let coreVersion = module.exports.version
let ganacheVariant = 'CLI'

let versionString = `${require.main.exports.name} v${cliVersion}`
if (require.main.exports.name !== 'ganache-core') {
  versionString += ` (ganache-core: ${coreVersion})`
}
